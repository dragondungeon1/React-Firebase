            ...
            <div className="overflow-x-auto relative shadow-md sm:rounded-lg mt-6">
                <table className="w-full text-sm text-left text-gray-500">
                    ...
                    <tr>
                        ...
                        <th scope="col" className="py-3 px-6">
                            <Link href="/create/technologies">
                                <button
                                    className="py-2 px-4 text-sm bg-green-500 text-white rounded-lg font-medium ml-8">Create
                                    new
                                </button>
                            </Link>
                        </th>
                    ...
                    {technologies.map((technologies) => (
                        <tr key={technologies.id} className="bg-white border-b">
                            ...
                            <td className="py-4 px-6">
                                <div className="flex gap-4">
                                    <Link href={{pathname: '/create/technologies', query: technologies}}>
                                        <button
                                    ...
                                    <button onClick={() => deleteTechnologies(technologies.id)}
